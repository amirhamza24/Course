...
async function run() {
    try {
        ...
        const usersCollection = client.db("topSpin").collection("users");
        const popularCollection = client.db("topSpin").collection("popular");
        const classCollection = client.db("topSpin").collection("classes");
        const addClassCollection = client.db("topSpin").collection("addClasses");
        const enrollCollection = client.db("topSpin").collection("enroll");
...
app.get("/", (req, res) => {
    res.send("TopSpin is Running");
});

app.listen(port, () => {
    console.log(`TopSpin Summer Camp is running on port: ${port}`);
});
